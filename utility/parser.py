...
def parse_args():
    ...
    parser.add_argument('--dataset', nargs='?', default='100k',help='Choose a dataset from {ml, yelp2018, amazon}')
    ...
    parser.add_argument('--layers', nargs='?', default='2', help='The number of layers')
    parser.add_argument('--batch_size', type=int, default=1024,help='Batch size.')
    parser.add_argument('--regs', nargs='?', default='[1e-5]',help='Regularizations.')
    parser.add_argument('--lr', type=float, default=0.01,help='Learning rate.')
    parser.add_argument('--add_noise', type=bool, default=False, help='noise sign')
